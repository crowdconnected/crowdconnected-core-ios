...
- (void)stop;
/// Start monitoring the device position and stream <code>Location</code> updates through <code>CrowdConnectedDelegate</code>.
/// This methods should only be called after the library has been successfully started using the <code>start(_:_:_:)</code> method.
- (void)startNavigation;
/// Stop monitoring the device position and the <code>Location</code> updates stream.
- (void)stopNavigation;
@end
